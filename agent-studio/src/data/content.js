...
export const deliveryItems = [
  {
    title: '十二节中文教程',
    summary: '从上手、提问、找工具，到做成资料站。',
  },
  {
    title: '七个可复制模板',
    summary: '改教程、拆项目、筛工具、写购买说明都能直接用。',
  },
  {
    title: '四个实战案例',
    summary: '资料整理、教程改写、售卖文案、工具筛选各有一套做法。',
  },
  {
    title: '九个资料入口',
    summary: '把公开资料、工具导航和云端说明集中放好。',
  },
]
...
export const toolCategories = [
  {
    title: '写字和改稿',
    summary: '适合写教程、改文案、整理大纲、把难懂内容改成大白话。',
    firstStep: '先准备一段原始资料，再让工具按“标题、步骤、坑点”整理。',
  },
  {
    title: '图片和海报',
    summary: '适合做封面图、课程海报、案例配图和社交平台素材。',
    firstStep: '先写清楚画面用途、风格、尺寸和必须出现的元素。',
  },
  {
    title: '视频和演示',
    summary: '适合做小课预告、操作演示、口播脚本和短视频素材。',
    firstStep: '先写脚本，再决定要真人、录屏还是图文动效。',
  },
  {
    title: '办公和汇报',
    summary: '适合做表格、清单、演示稿、会议纪要和项目说明。',
    firstStep: '先让工具把信息分栏，再人工确认数字和承诺。',
  },
  {
    title: '搜索和资料',
    summary: '适合找公开资料、整理链接、对比不同来源是否可信。',
    firstStep: '只记录入口和要点，不复制长文，最后改成自己的教程。',
  },
  {
    title: '编程和建站',
    summary: '适合搭资料站、改页面、做登录入口和发布线上页面。',
    firstStep: '先做最小页面，再逐步补内容和后台。',
  },
  {
    title: '教育和学习',
    summary: '适合把知识拆成课程、练习、问答和复习材料。',
    firstStep: '每节只解决一个问题，给结果，不堆概念。',
  },
  {
    title: '现成小助手',
    summary: '适合直接找一个能办事的助手，先试结果，再决定是否收进资料站。',
    firstStep: '先用一个真实小任务测试，不要只看介绍。',
  },
]
...
export const buyerQuestions = [
  {
    question: '买完以后怎么用？',
    answer: '你会拿到卡密。打开资料站，输入卡密，就能查看教程、案例、模板和资料入口。',
  },
  {
    question: '不会编程能不能看？',
    answer: '可以。当前内容按中文大白话写，重点是让你知道怎么问、怎么筛工具、怎么整理资料。',
  },
  {
    question: '这套内容不适合谁？',
    answer: '如果你想要很深的底层原理，或者希望一次性自动完成所有业务，这一版不适合。',
  },
  {
    question: '内容会怎么更新？',
    answer: '先用页面里的固定内容验证购买意愿。后续根据买家问题补章节、补模板、补真实案例。',
  },
  {
    question: '网上资料会不会直接照搬？',
    answer: '不会。公开资料只做入口和参考，站内教程会改成自己的中文步骤和检查清单。',
  },
]
...
export const purchaseInfo = {
  ...
  price: '一九九元',
  badge: '人工发卡',
  summary: '适合想先把资料站做出来、卖出去、再慢慢补后台的人。',
  includes: ['完整资料站入口', '中文教程和案例', '可复制模板', '后续小版本更新'],
  steps: ['付款后拿到卡密', '打开资料站输入卡密', '从五分钟上手开始看', '复制模板做自己的版本'],
  note: '首版先人工发卡。后续再接自动发卡和订单记录。',
}
...
export const updateNotes = [
  {
    date: '五月十四日',
    title: '补齐可售卖内容区',
    items: ['新增交付内容说明', '新增售前问答', '新增工具地图', '新增全部模板展示'],
  },
  {
    date: '五月十三日',
    title: '接入中文教程内容',
    items: ['补十二节大白话教程', '补四个实战案例', '补资料入口和复制模板'],
  },
  {
    date: '五月十二日',
    title: '完成卡密资料站雏形',
    items: ['卡密登录', '左侧菜单', '学习路径', '教程详情'],
  },
]
